...
return(
        ...
        <div className='container-confirm'>
            ...
            <button className='btn-x'onClick={prop.hiModal}>X</button>
            </div>
            <div className='vaje'>
         ...
         <div className='grid-inpt'>
             <input type="text" className='entry-sep' vlaue={userName} placeholder='نام کاربری' onChange={handleWriteName}/>
             {userNameErr && <div className='entry-message' ><p>نادرست میباشد</p></div>}
             <input type="text" className='entry-sep'  vlaue={password}  placeholder='گذرواژه' onChange={handlePassword}/>
